...
# Packages "caret" and "randomForest" were utilized to get correct results. Seed value was used for consistent result
...
# included complete columns.  Removed user name, timestamps and windows.  
